...
3. **Use the interface:**
   ...
   - Configure processing parameters:
     ...
     - **Left trim**: Asymmetric clipping from left side (meters)
...
| `left_trim` | Asymmetric left trimming | 0.0 | meters |
...
- Use **right_trim** and **left_trim** for asymmetric trenches with different wall geometries
